...
const DeleteUnitModal = ({show, unitId, getUnit, onHide, unit}) => {
    ...
    const handleDelete = async () => {
        try {
            ...
            if (res.status !== 200) { alert("Error al eliminar la unidad");
            return;
        }
        handleClose();
        await getUnit();
    ...
    return (
        <Modal show={show} onHide={handleClose} centered>
            ...
            <Modal.Body className={styles.containerModalBody}>
                <p>¿Está seguro de que desea eliminar la unidad <strong>"{unit}"</strong>?</p>
                <p> Los materiales asociadas a esta unidad quedaran con el campo unidad indefinido. </p> 
