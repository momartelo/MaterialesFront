            ...
            {filterMaterials
              ...
              .map((material) => (
                <MaterialItem2
                  ...
                  key={material._id}
                  material={material}
                  onClick={() => navigate(`/material/description/${material._id}`)}
                />
              ))}
          </div>
...
//   const [filterMaterials, setFilterMaterials] = useState([]);
//   const [currentPage, setCurrentPage] = useState(1);
//   const [materialsPerPage] = useState(8); // Cantidad de materiales por página
//   const { auth } = useContext(AuthContext);
//   const navigate = useNavigate();
...
//       });
//     } else if (sort === "precioEnPesos") {
//       filtered = filtered.slice().sort((a, b) => (a[sort] || 0) - (b[sort] || 0));
//     } else {
//       filtered = filtered.slice().sort((a, b) => (a[sort] || "").localeCompare(b[sort] || ""));
//     }
...
//     const currentMaterials = filtered.slice(indexOfFirstMaterial, indexOfLastMaterial);

//     console.log(filtered);
//     setFilterMaterials(currentMaterials);
//   }, [search, sort, materials, categories, currentPage, materialsPerPage]);
...
//   const renderPaginationControls = () => {
//     const pageNumbers = [];
//     for (let i = 1; i <= Math.ceil(filterMaterials.length/materialsPerPage); i++) {
//       pageNumbers.push(i);
//     }
//     return (
//       <ul className={styles.pagination}>
...
//         ))}
//         <li>
//           <button onClick={handleNextPage} disabled={currentPage === Math.ceil(filterMaterials.length / materialsPerPage)}>
//             Next
//           </button>
//         </li>
//       </ul>
